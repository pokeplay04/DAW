Para comenzar esta práctica tendremos que tener nuestra VPC ya creada la cual en mi caso se llama proyecto, tras esto crearemos la instancia dentro de la subred pública, la llamaremos
